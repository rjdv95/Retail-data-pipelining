...
get_customers_from_pg = BashOperator(
    ...
    bash_command='export CUSTOMER_DB_USER=retail_user;export CUSTOMER_DB_PASS=eduhilfe;/home/dgadiraju/etl-demo/etl-demo-env/bin/python /home/dgadiraju/etl-demo/app.py dev CUSTOMER_DB customers',
    dag=dag
)
